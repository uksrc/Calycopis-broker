...
/**
 * JPA Entity for abstract cost items.
 *
 */
@Entity
...
public abstract class AbstractCostItemEntity
implements AbstractCostItem
    {
     ...
     *
     */
    protected AbstractCostItemEntity()
        {
        }
     ...
     *
     */
    protected AbstractCostItemEntity(final ComponentEntity parent, final String kind, final String type, final String description)
        {
        this.parent = parent;
        this.kind = kind;
        this.type = type;
