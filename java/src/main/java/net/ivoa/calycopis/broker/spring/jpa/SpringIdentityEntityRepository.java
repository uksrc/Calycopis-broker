...
/**
 * Spring Data JPA repository for IdentityEntity.
 *
 */
@Repository
public interface SpringIdentityEntityRepository
extends SpringAbstractEntityRepository<IdentityEntity>, IdentityEntityRepository
    {
